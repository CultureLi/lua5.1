...
namespace Script
{
	...
	namespace helper
	{
		...
		template <typename Ret>
		inline Ret PopRet(lua_State *L) { Ret t = (Ret)lua_tonumber(L,-1); lua_pop(L,1);lua_decref(L);  return t;}
		template<>
...
template<typename Ret>
inline Ret LuaCall(const char *szFile, const char *szFuncName)
{
	lua_State *L = ScriptMgr::Instance().FindLuaState(szFile);
	if (!L)
	{
		printf("Script %s load fail!\n", szFile, szFuncName);
	...
	{
		lua_pop(L, 1);
		printf("[%s]:Call %s is not a function!\n", szFile, szFuncName);
		return Script::helper::DefaultRet<Ret>();
	}
	lua_incref(L);
	if (Script::helper::CheckSuccess(L, lua_pcall(L, 0, 1, 0), szFile, szFuncName))
...
inline Ret LuaCall(const char *szFile, const char *szFuncName, T1 arg1)
{
	lua_State *L = ScriptMgr::Instance().FindLuaState(szFile);
	if (!L)
	{
	...
	lua_incref(L);
	if (Script::helper::CheckSuccess(L, lua_pcall(L, 1, 1, 0), szFile, szFuncName))
		return Script::helper::PopRet<Ret>(L);
...
inline Ret LuaCall(const char *szFile, const char *szFuncName, T1 arg1, T2 arg2)
{
	lua_State *L = ScriptMgr::Instance().FindLuaState(szFile);
	if (!L)
	{
	...
	lua_incref(L);
	if (Script::helper::CheckSuccess(L, lua_pcall(L, 2, 1, 0), szFile, szFuncName))
		return Script::helper::PopRet<Ret>(L);
...
inline Ret LuaCall(const char *szFile, const char *szFuncName, T1 arg1, T2 arg2, T3 arg3)
{
	lua_State *L = ScriptMgr::Instance().FindLuaState(szFile);
	if (!L)
	{
	...
	lua_incref(L);
	if (Script::helper::CheckSuccess(L, lua_pcall(L, 3, 1, 0), szFile, szFuncName))
		return Script::helper::PopRet<Ret>(L);		
...
inline Ret LuaCall(const char *szFile, const char *szFuncName, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
{
	lua_State *L = ScriptMgr::Instance().FindLuaState(szFile);
	if (!L)
	{
...
inline Ret LuaCall(const char *szFile, const char *szFuncName, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5)
{
	lua_State *L = ScriptMgr::Instance().FindLuaState(szFile);
	if (!L)
	{
...
inline Ret LuaCall(const char *szFile, const char *szFuncName, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6)
{
	lua_State *L = ScriptMgr::Instance().FindLuaState(szFile);
	if (!L)
	{
...
inline Ret LuaCall(const char *szFile, const char *szFuncName, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7)
{
	lua_State *L = ScriptMgr::Instance().FindLuaState(szFile);
	if (!L)
	{
...
template<typename Ret>
inline Ret LuaCallF(lua_State* L ,const char* szFuncName, const char* sig, ...)
{
	std::vector<std::string> v = Script::helper::split(szFun, ".");
	if (v.size() == 0)
    ...
    lua_incref(L);
    if (Script::helper::CheckSuccess(L, lua_pcall(L, argNum, 1, 0), szFile, szFuncName))
        return Script::helper::PopRet<Ret>(L);
